            ...
            <main className="p-6 md:p-10 max-w-[1600px] mx-auto w-full">
                <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
                    <div>
                        ...
                        <p className="text-gray-500 mt-1 font-medium italic">Central Hardware Repository • {assets.filter(a => !a.assignedUser || a.assignedUser === 'Unassigned').length} available for claim</p>
                    </div>
